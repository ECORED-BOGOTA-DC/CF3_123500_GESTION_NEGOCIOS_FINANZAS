...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mt-5(data-aos="fade-down-right") Por otra parte, los procedimientos administrativos son un conjunto o sistema de reglas que rigen los procedimientos para la gestión de una organización. Estos procedimientos están destinados a establecer la eficiencia, la coherencia, la responsabilidad y la rendición de cuentas.
    p.mb-5(data-aos="fade-down-left") El proceso administrativo se comprende mediante los siguientes elementos administrativos:
    .tarjeta.fondo2.p-4.mb-5(data-aos="fade-down-right")
      SlyderA(tipo="b")
        .row.justify-content-around
          .col-xxl-4.col-xl-5.col-lg-6.col-md-11.col-sm-11.col-11.mb-4.mb-md-0
            h4.mt-0.mt-lg-4.ms-4.mb-4 Planeación
          ...
          .col-xxl-7.col-xl-6.col-lg-5.col-md-11.col-sm-11.col-11
            figure
              img.mt-1.mt-lg-4(src='@/assets/curso/tema1/slider1.png')
        .row.justify-content-around
          .col-xxl-4.col-xl-5.col-lg-6.col-md-11.col-sm-11.col-11.mb-4.mb-md-0
    ...
    p.text-center.my-5(data-aos="fade-down-left") Además, el proceso se define a partir de:
    ...
    .row.my-5(data-aos="fade-down-left")
      .col-auto
        h4.ps-5.pb-2.mb-0.fondo6 La importancia del proceso administrativo:
    p(data-aos="fade-down-right") Para que el mundo empresarial conserve su eficiencia en los procesos, se requiere de una buena gestión administrativa, en la que no solo se conformen con un adecuado trabajo, sino que las actividades se produzcan a través de fases y técnicas que le den norte al desempeño de los funcionarios y así alcanzar el cumplimiento de los objetivos y metas trazadas por la empresa.
    p.mb-5(data-aos="fade-down") Aunque las definiciones de los procesos administrativos conducen a la misma finalidad de generar excelencia en las unidades administrativas que conforman una organización, lo cierto es que la importancia de utilizar los procesos administrativos radica en
    ...
    p.my-5.text-center(data-aos="fade-down-left") Ejemplo de proceso administrativo:
    ImagenInfografica.color-secundario.mb-5(data-aos="fade-down-right")
      template(v-slot:imagen)
        figure
          img(src='@/assets/curso/tema1/infografica2.svg')

      .tarjeta.fondotarjeta.p-3(x="28.8%" y="22.4%" numero="1")
      ...
      .tarjeta.fondotarjeta.p-3(x="50%" y="7.7%" numero="2")
    ...
    p.mt-5(data-aos="fade-down-right") Las políticas comunican las responsabilidades individuales y de equipo, permitiendo así que todos trabajen juntos hacia los objetivos de la empresa. Los empleados entienden cómo realizar sus tareas de forma rápida y sencilla; de esta forma, los gerentes aplican el control en lugar de tener que fiscalizar las actividades de sus empleados.
    p.mb-5.text-center(data-aos="fade-down-left") Estos son algunos de los puntos de la organización en los que se suele aplicar políticas:
    ...
    p.my-5(data-aos="fade-down-right") Las políticas organizacionales bien escritas promueven el cumplimiento, agilizan los procesos internos y limitan los riesgos de responsabilidad, también establecen la cultura de la empresa y guían las funciones diarias.
    .bloque-texto-g.fondo1.p-3.p-sm-4.p-md-5(data-aos="fade-down-left")
      .bloque-texto-g__img(
    ...
    .row.justify-content-center
      .col-xxl-10.col-xl-10.col-lg-10.col-md-12
        AcordionA(data-aos="fade-up-left").my-5(tipo="a" clase-tarjeta="tarjeta fondo4")
          .row.justify-content-center(titulo="Examine los compromisos legales")
            .col-md-4
              figure
          ...
          .row.justify-content-center(titulo="Analice las necesidades del entorno")
            .col-md-4
              figure
    ...
    p.mb-5(data-aos="fade-down-left") Dentro de la gestión del talento humano, se encuentran acciones que van desde la incorporación de colaboradores, pasando por la gestión del desempeño, hasta la retención. Aquí, se presentan las actividades más relevantes de esta gestión:
    ...
    p(data-aos="fade-down-right") Se tiene en cuenta que la gestión del talento necesita transformarse para adaptarse a las últimas tendencias de talento, las disrupciones digitales y las expectativas de los empleados; teniendo en cuenta este ambiente, se diseñan los modelos para gestionar mejor los colaboradores. Por lo tanto, debe poder adaptarse a las necesidades cambiantes de la organización, las expectativas de talento en evolución y el ritmo establecido por los cambios dentro del negocio. 
    ...
    .row.justify-content-center.my-5(data-aos="fade-down-left")
      .col-xxl-6.col-xl-6.col-lg-6.col-md-11.col-sm-11.col-12.mt-3
        LineaTiempoD
    ...
    p.my-5(data-aos="fade-down-right") Al salir al mercado, cualquier producto o servicio debe estar respaldado por compromisos de desempeño que sean relevantes para sus clientes y consumidores. Esos compromisos pueden ser específicos del producto/servicio o genéricos de la organización:
    .row.justify-content-center(data-aos="fade-down-left")
      .col-xxl-6.col-xl-6.col-lg-6.col-md-8.col-sm-11.col-12
        table
          tr.align-items-centee.colorborde
            td.colorborde
              h4.text-center Específicos
            td.colorborde2
              h4.text-center Genéricos
          tr
            td.colorborde
              .row.justify-content-center.align-items-center.pb-2
                ...
                .col-xxl-4.col-xl-4.col-lg-4.col-md-4.col-sm-4.col-4
                  img.nomostrar(src='@/assets/curso/tema1/precio.svg')
              .row.justify-content-center.align-items-center.py-2
                .col-xxl-7.col-xl-7.col-lg-7.col-md-7.col-sm-7.col-7
                  p.ms-5 Entrega
                .col-xxl-4.col-xl-4.col-lg-4.col-md-4.col-sm-4.col-4
                  img.nomostrar(src='@/assets/curso/tema1/entrega.svg')
              .row.justify-content-center.align-items-center.py-2
                .col-xxl-7.col-xl-7.col-lg-7.col-md-7.col-sm-7.col-7
                  p.ms-0.ms-sm-3 Mantenimiento
                .col-xxl-4.col-xl-4.col-lg-4.col-md-4.col-sm-4.col-4
                  img.nomostrar(src='@/assets/curso/tema1/mtto.svg')
              .row.justify-content-center.align-items-center.pt-2
                .col-xxl-7.col-xl-7.col-lg-7.col-md-7.col-sm-7.col-7
                  p.ms-5 Soporte
                .col-xxl-4.col-xl-4.col-lg-4.col-md-4.col-sm-4.col-4
                  img.nomostrar(src='@/assets/curso/tema1/soporte.svg')
            td.colorborde3.pt-0
              .row.justify-content-center.align-items-center.pb-2
                .col-xxl-4.col-xl-4.col-lg-4.col-md-4.col-sm-4.col-4.pt-0
                  img.mt-0(src='@/assets/curso/tema1/marca.svg')
                .col-xxl-7.col-xl-7.col-lg-7.col-md-7.col-sm-7.col-7.pt-0
                  p Marca
              .row.justify-content-center.align-items-center.py-2
                .col-xxl-4.col-xl-4.col-lg-4.col-md-4.col-sm-4.col-4
                  img(src='@/assets/curso/tema1/standares.svg')
                .col-xxl-7.col-xl-7.col-lg-7.col-md-7.col-sm-7.col-8
                  p.desborde Estándares éticos
              .row.justify-content-center.align-items-center.pt-2
                .col-xxl-4.col-xl-4.col-lg-4.col-md-4.col-sm-4.col-4
                  img(src='@/assets/curso/tema1/norma.svg')
                .col-xxl-7.col-xl-7.col-lg-7.col-md-7.col-sm-7.col-8
                  p.desborde Normativa
              .row.justify-content-center.align-items-center.pt-2
                .col-xxl-12.margencelda

    p.mt-5(data-aos="fade-down-right") La gestión comercial es el proceso a través del cual se reúnen, evalúan y concilian los compromisos de desempeño requeridos, teniendo en cuenta las necesidades e intereses de todas las partes interesadas relevantes y asegurando su sostenibilidad.
    p.mb-5(data-aos="fade-down-left") En algunas empresas, la función de gestión comercial se limita a las actividades relacionadas con:
    .row.justify-content-center.mb-5(data-aos="fade-down")
      .col-xxl-10.col-xl-10.col-lg-11.col-md-12.col-sm-12.col-12
        img(src='@/assets/curso/tema1/figura4.svg')

    p(data-aos="fade-down-right") Algunas de las organizaciones públicas y privadas no tienen un departamento de gestión comercial, solo cuentan con un área de contratación. En tales casos, las actividades previas al contrato están a cargo principalmente del equipo jurídico y técnico, que cuenta con el respaldo de finanzas para la revisión de la oferta.
    p.mb-5(data-aos="fade-down-left") La gestión comercial ayuda a la empresa con las siguientes tareas esenciales:
    ...
    p.mt-5(data-aos="fade-down-right") El área comercial, en la mayoría de las organizaciones, es un punto de encuentro que funciona como canal formal para las comunicaciones externas y está autorizada para acordar asuntos comerciales
    .row.justify-content-center(data-aos="fade-down-left")
      .col-xxl-10.col-xl-10.col-lg-10.col-md-12
    ...
    p.mt-5(data-aos="fade-down-left") El comercio global brinda a los consumidores y países la oportunidad de estar expuestos a bienes y servicios que no están disponibles en sus propios países, o que son más costosos a nivel nacional, ofreciendo la oportunidad de adquirir estos productos y servicios en el exterior. Es así como, a través de la necesidad de un país, el comercio internacional genera el intercambio de productos en otros territorios, produciendo la economía internacional.
    p.mb-5(data-aos="fade-down-right") En otras palabras, el comercio internacional es la relación existente de compra y venta entre países. Ahora bien, dentro de lo que es el comercio internacional, se describen dos palabras claves para que exista la economía internacional:
    ...
    p.my-5(data-aos="fade-down-right") Importar y exportar puede ayudar a que su negocio se expanda en el país o en el extranjero, pero es importante cumplir con todas las leyes y reglamentos que exigen los países involucrados. Conozca cuáles son los requisitos de importación y exportación, además de otra información sobre el proceso.
    .row.justify-content-center(data-aos="fade-down")
      .col-xxl-5.col-xxl-5.col-lg-5.col-md-11.col-sm-12.col-12
    ...
    p.mt-5(data-aos="fade-down-right") Las empresas prefieren importar y exportar porque es una de las rutas más simples para ingresar al comercio global. Requiere menos inversión en términos de tiempo y dinero en comparación con otros métodos para ingresar al comercio global. Es comparativamente menos riesgoso en comparación con diferentes rutas de ingreso al negocio internacional.
    p.mb-5(data-aos="fade-down-left") La operación para establecer la balanza comercial es la divergencia entre el valor de las exportaciones y el valor de las importaciones, así:
    .row.justify-content-center(data-aos="fade-down-right")
